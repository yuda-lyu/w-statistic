...
arr = ['-2.5', -2.5, '-1', -1, '-0.1', -0.1, '0', 0, '0.1', 0.1, '1', 1, '2.5', 2.5, 22.5]
console.log(arrMovingAverage(arr, { mode: 'SMA', selectCountHalf: 3 }))
// => [
//                   -2.5,                 -2.5,
//                     -2,                 -1.5,
...
arr = ['-2.5', -2.5, '-1', -1, '-0.1', -0.1, '0', 0, '0.1', 0.1, '1', 1, '2.5', 2.5, 22.5]
console.log(arrMovingAverage(arr, { mode: 'EMA', selectCountHalf: 3 }))
// => [
//   -2.5,
//   -2.5,
//   -1.75,
