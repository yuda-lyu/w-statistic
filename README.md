...
> **Note:** w-statistic is mainly dependent on `simple-statistics` and `lodash` and `wsemi`.
```alias
npm i w-statistic
```
...
```alias
<script src="https://cdn.jsdelivr.net/npm/w-statistic@1.0.2/dist/w-statistic.umd.js"></script>
```
