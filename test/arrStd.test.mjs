...
describe(`arrStd`, function() {
    ...
    it(`should return 40.847473507599254 when input [55, 68, 45, 78, 150, 241, 162, 156, 182, 125, 75, 89, 91, 95, 92, 65, 75, 85, 95, 105, 132, 120, 142, 110, 111, 130, 128, 130, 108, 109]`, function() {
        let r = arrStd([55, 68, 45, 78, 150, 241, 162, 156, 182, 125, 75, 89, 91, 95, 92, 65, 75, 85, 95, 105, 132, 120, 142, 110, 111, 130, 128, 130, 108, 109])
        let rr = 40.847473507599254
        assert.strict.deepStrictEqual(r, rr)
    })
