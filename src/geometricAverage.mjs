 ...
 * 計算陣列內有效數字之幾何平均值
 *
 * Unit Test: {@link https://github.com/yuda-lyu/w-statistic/blob/master/test/geometricAverage.test.js Github}
 ...
 * console.log(geometricAverage(arr))
 * // => 1.0499093195835956
 *
