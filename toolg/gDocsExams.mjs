...
function main() {
    ...
    // //url
    // let url = `https://cdn.jsdelivr.net/npm/w-statistic@${pks.version}/dist/w-statistic.umd.js`
    // let urlww = `https://cdn.jsdelivr.net/npm/w-statistic@${pks.version}/dist/w-statistic.wk.umd.js`
    ...
    //     //replace
    //     let r
    //     r = `../dist/w-statistic.umd.js`
    //     c = c.replace(r, url)
    //     r = `../dist/w-statistic.wk.umd.js`
    //     c = c.replace(r, urlww)
